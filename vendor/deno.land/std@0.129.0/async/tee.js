    ...
    Queue.prototype.next = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, __classPrivateFieldGet(this, _Queue_source, "f").next()];
                    case 1:
                        result = _a.sent();
                        if (!result.done) {
                            nextNode = {
...
function tee(iterable, n) {
        ...
        return __asyncGenerator(this, arguments, function generator_1() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (!true) return [3, 9];
                        if (!buffer.next) return [3, 4];
                        buffer = buffer.next;
                        return [4, __await(buffer.value)];
                    case 2: return [4, _a.sent()];
                    case 3:
                        _a.sent();
                        return [3, 8];
                    case 4:
                        if (!queue.done) return [3, 6];
                        return [4, __await(void 0)];
                    case 5: return [2, _a.sent()];
                    case 6: return [4, __await(queue.next())];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    case 8: return [3, 1];
    ...
    var branches = Array.from({ length: n }).map(function () { return generator(); });
    return branches;
}
exports.tee = tee;
