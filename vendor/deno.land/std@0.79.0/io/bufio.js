            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        copied = (0, mod_ts_1.copyBytes)(this.buf.subarray(this.r, this.w), p, 0);
                        this.r += copied;
                        return [2, copied];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, Deno.writeAll(this.writer, this.buf.subarray(0, this.usedBufferBytes))];
                    case 2:
                        _a.sent();
                        return [3, 4];
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5: return [3, 8];
                    case 6:
                        numBytesWritten = (0, mod_ts_1.copyBytes)(data, this.buf, this.usedBufferBytes);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    ...
                    return [4, __await(Deno.writeAll(inputBuffer, sliceRead))];
                case 9:
                    _a.sent();
...
function readLines(reader) {
    return __asyncGenerator(this, arguments, function readLines_1() {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [5, __values(__asyncDelegator(__asyncValues(readStringDelim(reader, "\n"))))];
