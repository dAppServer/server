    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 5]);
                    return [4, Deno.lstat(dir)];
                case 1:
                    fileInfo = _a.sent();
                    if (!fileInfo.isDirectory) {
                        throw new Error("Ensure path exists, expected 'dir', got '".concat((0, _util_ts_1.getFileInfoType)(fileInfo), "'"));
                    }
                    return [3, 5];
                case 2:
                    err_1 = _a.sent();
                    if (!(err_1 instanceof Deno.errors.NotFound)) return [3, 4];
