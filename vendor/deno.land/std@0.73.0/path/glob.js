...
function globToRegExp(glob, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.extended, extended = _c === void 0 ? true : _c, _d = _b.globstar, globstarOption = _d === void 0 ? true : _d, _e = _b.os, os = _e === void 0 ? _constants_ts_1.NATIVE_OS : _e;
    if (glob == "") {
        return /(?!)/;
    }
    var sep = os == "windows" ? "(?:\\\\|/)+" : "/+";
    ...
    for (var j = 0; j < glob.length;) {
        ...
        if (groupStack.length > 0 || inRange || inEscape) {
            segment = "";
            for (var _i = 0, _f = glob.slice(j, i); _i < _f.length; _i++) {
                var c = _f[_i];
