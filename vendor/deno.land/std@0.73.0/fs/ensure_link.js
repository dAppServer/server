...
exports.ensureLinkSync = exports.ensureLink = void 0;
...
function ensureLink(src, dest) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, (0, exists_ts_1.exists)(dest)];
                case 1:
                ...
                case 2:
                    ...
                    return [2];
                case 3: return [4, (0, ensure_dir_ts_1.ensureDir)(path.dirname(dest))];
                case 4:
                    _a.sent();
                    return [4, Deno.link(src, dest)];
                case 5:
                    _a.sent();
                    return [2];
            }
