...
var _Sha1_blocks, _Sha1_block, _Sha1_start, _Sha1_bytes, _Sha1_hBytes, _Sha1_finalized, _Sha1_hashed, _Sha1_h0, _Sha1_h1, _Sha1_h2, _Sha1_h3, _Sha1_h4, _Sha1_lastByteIndex, _HmacSha1_sharedMemory, _HmacSha1_inner, _HmacSha1_oKeyPad;
exports.__esModule = true;
exports.HmacSha1 = exports.Sha1 = void 0;
...
var Sha1 = (function () {
    ...
    Sha1.prototype.init = function (sharedMemory) {
        if (sharedMemory) {
...
var HmacSha1 = (function (_super) {
    ...
    function HmacSha1(secretKey, sharedMemory) {
        if (sharedMemory === void 0) { sharedMemory = false; }
        var _this = _super.call(this, sharedMemory) || this;
        _HmacSha1_sharedMemory.set(_this, void 0);
        _HmacSha1_inner.set(_this, void 0);
        _HmacSha1_oKeyPad.set(_this, void 0);
        var key;
        ...
        __classPrivateFieldSet(_this, _HmacSha1_oKeyPad, oKeyPad, "f");
        __classPrivateFieldSet(_this, _HmacSha1_inner, true, "f");
        __classPrivateFieldSet(_this, _HmacSha1_sharedMemory, sharedMemory, "f");
        return _this;
    }
    HmacSha1.prototype.finalize = function () {
        _super.prototype.finalize.call(this);
        if (__classPrivateFieldGet(this, _HmacSha1_inner, "f")) {
            __classPrivateFieldSet(this, _HmacSha1_inner, false, "f");
            var innerHash = this.array();
            _super.prototype.init.call(this, __classPrivateFieldGet(this, _HmacSha1_sharedMemory, "f"));
            this.update(__classPrivateFieldGet(this, _HmacSha1_oKeyPad, "f"));
...
_HmacSha1_sharedMemory = new WeakMap(), _HmacSha1_inner = new WeakMap(), _HmacSha1_oKeyPad = new WeakMap();
