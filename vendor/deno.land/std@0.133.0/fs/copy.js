...
var DenoUnstable = require("../_deno_unstable.ts");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4, DenoUnstable.utime(dest, statInfo.atime, statInfo.mtime)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [2];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!os_ts_1.isWindows) return [3, 5];
...
function copyDir(src, dest, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4, ensureValidCopy(src, dest, __assign(__assign({}, options), { isFolder: true }))];
                case 1:
                    destStat = _d.sent();
                ...
                case 4:
                    ...
                    return [4, DenoUnstable.utime(dest, srcStatInfo.atime, srcStatInfo.mtime)];
                case 5:
                    _d.sent();
                    _d.label = 6;
                case 6:
