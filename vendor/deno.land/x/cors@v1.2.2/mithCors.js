...
exports.mithCors = void 0;
var cors_ts_1 = require("./cors.ts");
var mithCors = function (o) {
    ...
    return (function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
        var serverRequest, options, corsOptions, originDelegate, requestMethod, getRequestHeader, getResponseHeader, setResponseHeader, setStatus, end, origin_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    requestMethod = serverRequest.method;
                    getRequestHeader = function (headerKey) {
                        return serverRequest.headers.get(headerKey);
                    };
                    ...
                    setResponseHeader = function (headerKey, headerValue) {
                        return response.headers.set(headerKey, headerValue);
                    };
                    setStatus = function (statusCode) { return (response.status = statusCode); };
                    end = function () { };
