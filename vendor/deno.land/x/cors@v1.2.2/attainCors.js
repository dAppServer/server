...
exports.attainCors = void 0;
var cors_ts_1 = require("./cors.ts");
var attainCors = function (o) {
    var corsOptionsDelegate = cors_ts_1.Cors.produceCorsOptionsDelegate(o);
    return function cors(request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var fakeNext, options, corsOptions, originDelegate, requestMethod, getRequestHeader, getResponseHeader, setResponseHeader, setStatus, end, origin_1, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        fakeNext = function () { return undefined; };
