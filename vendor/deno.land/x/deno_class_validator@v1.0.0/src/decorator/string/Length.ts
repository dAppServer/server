  ...
  return ValidateBy(
    {
      ...
      validator: {
        ...
        defaultMessage: buildMessage((eachPrefix, args: any) => {
          const isMinLength = args.constraints[0] !== null &&
            args.constraints[0] !== undefined;
          const isMaxLength = args.constraints[1] !== null &&
            args.constraints[1] !== undefined;
          if (
            isMinLength &&
