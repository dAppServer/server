import { a as exports$4, e as exports$5 } from '../_/b1dbe139.js';
import exports$3 from './util!cjs';
 ...
 */
var util = exports$3;
var binarySearch = exports;
var ArraySet = exports$4.ArraySet;
var base64VLQ = exports$5;
var quickSort = exports$1.quickSort;
...
SourceMapConsumer.prototype.eachMapping = function SourceMapConsumer_eachMapping(aCallback, aContext, aOrder) {
  ...
  mappings.map(function (mapping) {
    ...
    source = util.computeSourceURL(sourceRoot, source, (this || _global)._sourceMapURL);
    return {
      source: source,
...
exports$2.SourceMapConsumer = SourceMapConsumer;
/**
...
BasicSourceMapConsumer.prototype._findSourceIndex = function (aSource) {
  ...
  if ((this || _global).sourceRoot != null) {
    relativeSource = util.relative((this || _global).sourceRoot, relativeSource);
  }

  if ((this || _global)._sources.has(relativeSource)) {
    return (this || _global)._sources.indexOf(relativeSource);
  ...
  for (i = 0; i < (this || _global)._absoluteSources.length; ++i) {
    if ((this || _global)._absoluteSources[i] == aSource) {
      return i;
    }
  }
...
Object.defineProperty(BasicSourceMapConsumer.prototype, "sources", {
  get: function () {
    return (this || _global)._absoluteSources.slice();
  }
});
/**
  ...
  if (index >= 0) {
    ...
    if (mapping.generatedLine === needle.generatedLine) {
      ...
      if (source !== null) {
        ...
        source = util.computeSourceURL((this || _global).sourceRoot, source, (this || _global)._sourceMapURL);
      }
...
BasicSourceMapConsumer.prototype.sourceContentFor = function SourceMapConsumer_sourceContentFor(aSource, nullOnMissing) {
  ...
  if (index >= 0) {
    return (this || _global).sourcesContent[index];
  }
  ...
  if ((this || _global).sourceRoot != null && (url = util.urlParse((this || _global).sourceRoot))) {
    ...
    if ((!url.path || url.path == "/") && (this || _global)._sources.has("/" + relativeSource)) {
      return (this || _global).sourcesContent[(this || _global)._sources.indexOf("/" + relativeSource)];
    }
...
exports$2.BasicSourceMapConsumer = BasicSourceMapConsumer;
/**
...
IndexedSourceMapConsumer.prototype._parseMappings = function IndexedSourceMapConsumer_parseMappings(aStr, aSourceRoot) {
  ...
  for (var i = 0; i < (this || _global)._sections.length; i++) {
    ...
    for (var j = 0; j < sectionMappings.length; j++) {
      ...
      source = util.computeSourceURL(section.consumer.sourceRoot, source, (this || _global)._sourceMapURL);
      ...
      if (mapping.name) {
        ...
        name = (this || _global)._names.indexOf(name);
...
exports$2.IndexedSourceMapConsumer = IndexedSourceMapConsumer;
const _SourceMapConsumer = exports$2.SourceMapConsumer,
      _BasicSourceMapConsumer = exports$2.BasicSourceMapConsumer,
      _IndexedSourceMapConsumer = exports$2.IndexedSourceMapConsumer;

export default exports$2;
export { _BasicSourceMapConsumer as BasicSourceMapConsumer, _IndexedSourceMapConsumer as IndexedSourceMapConsumer, _SourceMapConsumer as SourceMapConsumer };
