...
export class LetheanToolsProvider {
  public static config() {
    return new Command().description("LVMGMT Replacment")
      ...
      .option(
        "-C, --generate-client-config",
        "Generate config for given service",
      )
      .option(
        "--sdp-service-crt",
      ...
      .option(
        "--sdp-service-refunds",
        "Allow refunds for Service (for SDP service edit/creation only)",
      )
      .option(
        "--sdp-service-dlspeed",
        "Download speed for Service (for SDP service edit/creation only)",
      )
      .option(
        "--sdp-service-ulspeed",
        "Upload speed for Service (for SDP service edit/creation only)",
      )
      .option(
        "--sdp-service-prepaid-mins",
        "Prepaid minutes for Service (for SDP service edit/creation only)",
      )
      .option(
        "--sdp-service-verifications",
        "Verifications needed for Service (for SDP service edit/creation only)",
      )
